...
describe('Login application', () => {
    ...
    it('user fill the valid userName and password', async()=>{
        ...
        // await LoginPage.enterUsername(loginUser.username);
...
describe('add user in application', () =>{
    ...
    it('add values in user page', async()=>{
        ...
        await addUserPage.addEmpName('Garry White','admin123','admin123');
    })
    it('click on save button', async()=>{
        const value = await addUserPage.addRandomUserName('Aa@');
...
describe('add a time sheet',()=>{
  ...
  describe('add recruitment',()=>{
      ...
      it('selct the date from and to ',async()=>{
        await RecruitmentPage.clickOnDateFrom('2022-04-22')
        await RecruitmentPage.clickOnDateTo('2022-04-23')
     })
      ...
      it('click on search button',async()=>{
          await RecruitmentPage.clickOnSearchButton();
      })
